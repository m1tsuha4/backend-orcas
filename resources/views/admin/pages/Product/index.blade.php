            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-end">
                        <a href="{{ route('product.create') }}" class="btn bg-gradient-success"><i
                            ...
                            <x-admin.table id="datatable">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <x-admin.td class="text-center">{{ $item->Category->category ?? '-' }}</x-admin.td>
                                        <x-admin.td class="text-center">{{ $item->link ?? '-' }}</x-admin.td>
                                        <x-admin.td class="text-center">
                                            <a href="{{ route('product.edit', $item->id) }}" class="btn bg-gradient-info"><i
