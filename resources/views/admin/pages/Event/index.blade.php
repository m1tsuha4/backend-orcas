            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-end">
                        <a href="{{ route('event.create') }}" class="btn bg-gradient-success"><i
                            ...
                            <x-admin.table id="datatable">
                                @slot('header')
                                    <tr>
                                        ...
                                        {{-- <x-admin.th>Sub Judul</x-admin.th> --}}
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        {{-- <x-admin.td maxWidth="300px">{{ $item->sub_title ?? '-' }}</x-admin.td> --}}
                                        ...
                                        <x-admin.td maxWidth="300px">
                                            {!! \Illuminate\Support\Str::words($item->desc ?? '', 12, '...') !!}
                                        </x-admin.td>
                                        <x-admin.td class="text-center">
                                            {{ \Carbon\Carbon::parse($item->date_open)->translatedFormat('j F Y') }} -
                                            {{ \Carbon\Carbon::parse($item->date_close)->translatedFormat('j F Y') }}
                                        </x-admin.td>
                                        <x-admin.td class="text-center">
                                        ...
                                        <x-admin.td class="text-center">
                                            <a href="{{ route('event.edit', $item->id) }}" class="btn bg-gradient-info"><i
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="hapusProjectLabel">Hapus Data Event
                                                        </h1>
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route('event.destroy', $item->id) }}"
